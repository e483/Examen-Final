...
class Desk:
    ...
    def funcion1(self):
        ...
        #self.message['text'] = 'La fecha de nacimiento en numeros es: \n decimales: {}/{}/{} y hexadecimal: {}/{}/{}'.format(dia,mes,anio,hexdia,hexmes,hexanio)
        self.message['text'] = ' {}/{}/{} =  {}/{}/{}'.format(dia,mes,anio,hexdia,hexmes,hexanio)
        #        self.message['text'] = 'La fecha de nacimiento en numeros es: \n decimales: {}/{}/{} y \n binarios:{}/{}/{} \n hexadecimal: {}/{}/{}'.format(dia,mes,anio,bindia,binmes,binanio,hexdia,hexmes,hexanio)
